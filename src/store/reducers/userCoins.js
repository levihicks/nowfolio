...
const reducer = ( state = initialState, action ) => {
    switch( action.type ) {
        ...
        case actionTypes.REMOVE_USER_COIN_FAIL: return updateUserCoinFail( state, action );
        case actionTypes.UPDATE_USER_COIN_START: return updateUserCoinStart( state, action );
        case actionTypes.UPDATE_USER_COIN_SUCCESS: return updateUserCoinSuccess( state, action );
        case actionTypes.UPDATE_USER_COIN_FAIL: return removeUserCoinFail( state, action );
